...
public abstract class Order {
    ...
    private static void matchOrders(long assetId) {
        ...
        while ((askOrder = Ask.getNextOrder(assetId)) != null
            ...
            if (askOrder.getPriceTQT() > bidOrder.getPriceTQT()) {
                break;
            }
            ...
            askAccount.addToBalanceAndUnconfirmedBalanceTQT(LedgerEvent.ASSET_TRADE, askOrder.getId(),
                    Math.multiplyExact(trade.getQuantityQNT(), trade.getPriceTQT()));
            ...
            bidAccount.addToBalanceTQT(LedgerEvent.ASSET_TRADE, bidOrder.getId(),
                    -Math.multiplyExact(trade.getQuantityQNT(), trade.getPriceTQT()));
            bidAccount.addToUnconfirmedBalanceTQT(LedgerEvent.ASSET_TRADE, bidOrder.getId(),
                    Math.multiplyExact(trade.getQuantityQNT(), (bidOrder.getPriceTQT() - trade.getPriceTQT())));
        }
    ...
    private Order(Transaction transaction, Attachment.ColoredCoinsOrderPlacement attachment) {
        ...
        this.priceTQT = attachment.getPriceTQT();
    ...
    public String toString() {
        return getClass().getSimpleName() + " id: " + Long.toUnsignedString(id) + " account: " + Long.toUnsignedString(accountId)
                + " asset: " + Long.toUnsignedString(assetId) + " price: " + priceTQT + " quantity: " + quantityQNT
    ...
    */
    ...
    public static final class Ask extends Order {
        ...
        public int compareTo(Ask o) {
            if (this.getPriceTQT() < o.getPriceTQT()) {
                return -1;
            } else if (this.getPriceTQT() > o.getPriceTQT()) {
                return 1;
            } else {
