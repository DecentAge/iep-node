...
public final class Asset {
    ...
    // Deactivate Asset full delete
    public static boolean isEnabled() {
        if (Xin.getBlockchain().getLastBlock().getHeight() >= Constants.ASSET_FULLDELETE_START_BLOCK) {
            return true;
        }
    ...
    void deleteAssetCompletely() {
        Account.AccountAsset accountAsset = Account.getAccountAsset(this.accountId, assetId);
