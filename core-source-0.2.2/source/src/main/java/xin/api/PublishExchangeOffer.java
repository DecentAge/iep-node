...
/**
 * Publish exchange offer for {@link xin.CurrencyType#EXCHANGEABLE} currency
 * <p>
 * Parameters
 * <ul>
 * <li>currency - currency id of an active currency
 * <li>buyRateTQT - token amount for buying a currency unit specified in TQT
 * <li>sellRateTQT - token amount for selling a currency unit specified in TQT
 ...
 * Typically the buyRateTQT specified would be less than the sellRateTQT thus allowing the publisher to make profit
 * <p>
 * <p>
...
public final class PublishExchangeOffer extends CreateTransaction {
    ...
    private PublishExchangeOffer() {
        super(new APITag[]{APITag.MS, APITag.CREATE_TRANSACTION}, "currency", "buyRateTQT", "sellRateTQT",
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws XinException {
        ...
        long buyRateTQT = ParameterParser.getLong(req, "buyRateTQT", 0, Long.MAX_VALUE, true);
        long sellRateTQT = ParameterParser.getLong(req, "sellRateTQT", 0, Long.MAX_VALUE, true);
        ...
        Attachment attachment = new Attachment.MonetarySystemPublishExchangeOffer(currency.getId(), buyRateTQT, sellRateTQT,
                totalBuyLimit, totalSellLimit, initialBuySupply, initialSellSupply, expirationHeight);
