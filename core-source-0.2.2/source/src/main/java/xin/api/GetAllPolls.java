...
public class GetAllPolls extends APIServlet.APIRequestHandler {

    static final GetAllPolls instance = new GetAllPolls();
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws XinException {
        ...
        try {
            if (accountId == 0) {
                if (finishedOnly) {
                    polls = Poll.getPollsFinishingAtOrBefore(Xin.getBlockchain().getHeight(), firstIndex, lastIndex);
