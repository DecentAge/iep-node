...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "XIN-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws XinException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new XinException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseXIN(String xin) {
        return parseStringFraction(xin, 8, Constants.MAX_BALANCE_XIN);
    }
