...
public class Tester {
    ...
    public Tester(String secretPhrase) {
        ...
        if (account != null) {
            this.initialBalance = account.getBalanceTQT();
            this.initialUnconfirmedBalance = account.getUnconfirmedBalanceTQT();
            this.initialEffectiveBalance = account.getEffectiveBalanceTQT();
    ...
    public long getBalanceDiff() {
        return Account.getAccount(id).getBalanceTQT() - initialBalance;
    }

    public long getUnconfirmedBalanceDiff() {
        return Account.getAccount(id).getUnconfirmedBalanceTQT() - initialUnconfirmedBalance;
    }
    ...
    public long getBalance() {
        return getAccount().getBalanceTQT();
    }
    ...
    public static Tester createAndAdd(String secretPhrase, long amountNQT) {
        ...
        account.addToBalanceAndUnconfirmedBalanceTQT(null, 0, Constants.ONE_XIN * 1000000);
