...
public class AccountLedger {
    ...
    static boolean mustLogEntry(long accountId, boolean isUnconfirmed) {
        ...
        if (trimKeep > 0 && blockchain.getHeight() <= Constants.LAST_KNOWN_BLOCK_HEIGHT - trimKeep) {
            return false;
        }
        //
    ...
    public enum LedgerEvent {
        ...
        // TYPE SUBSCRIPTION
        SUBSCRIPTION_SUBSCRIBE(60, true),
        SUBSCRIPTION_CANCEL(61, true),
        SUBSCRIPTION_PAYMENT(62, true),
        // TYPE ESCROW
        ESCROW_CREATION(70, true),
        ESCROW_SIGN(71, true),
        ESCROW_RESULT(72, true),
        // TYPE AT
        AUTOMATED_TRANSACTION_CREATION(80, true),
        AT_PAYMENT(81, true);
