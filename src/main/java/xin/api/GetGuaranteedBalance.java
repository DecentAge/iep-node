...
public final class GetGuaranteedBalance extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws XinException {
        ...
        if (account == null) {
            response.put("guaranteedBalanceTQT", "0");
        } else {
            response.put("guaranteedBalanceTQT", String.valueOf(account.getGuaranteedBalanceTQT(numberOfConfirmations, Xin.getBlockchain().getHeight())));
        }
