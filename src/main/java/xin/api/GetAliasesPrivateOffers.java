...
public final class GetAliasesPrivateOffers extends APIServlet.APIRequestHandler {

    static final GetAliasesPrivateOffers instance = new GetAliasesPrivateOffers();
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        long recipientId = ParameterParser.getAccountId(req, true);

        String sql = "SELECT ALIAS.id, ALIAS.account_id, ALIAS.alias_name, ALIAS_OFFER.price, ALIAS.timestamp FROM ALIAS_OFFER " +
                     "INNER JOIN ALIAS ON ALIAS_OFFER.id = ALIAS.id " +
                     "WHERE ALIAS_OFFER.buyer_id = ? " +
