 ...
 * This value is multiplied by current currency rate and the result is added to the sender token account balance.
 * </ul>
 * <p>
 * Constraints
 * <p>This transaction is allowed only when the currency is {@link xin.CurrencyType#CLAIMABLE} and is already active.<br>
 */
