...
public interface Appendix {
    ...
    class Message extends AbstractAppendix {
        ...
        void validate(Transaction transaction) throws XinException.ValidationException {
            ...
            if(transaction.getType().getType()==TransactionType.TYPE_MESSAGING) {
                throw new XinException.NotYetEnabledException("Plain messages are not yet supported");
            }
    ...
    class PrunablePlainMessage extends Appendix.AbstractAppendix implements Prunable {
        ...
        void validate(Transaction transaction) throws XinException.ValidationException {
            if(transaction.getType().getType()==TransactionType.TYPE_MESSAGING) {
                throw new XinException.NotYetEnabledException("Prunable Plain messages are not yet supported");
            }
