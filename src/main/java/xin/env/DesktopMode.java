...
public class DesktopMode implements RuntimeMode {
    ...
    public void launchDesktopApplication() {
        ...
        try {
            desktopApplication = Class.forName("xindesktop.DesktopApplication");
            desktopApplication.getMethod("launch").invoke(null);
        } catch (ReflectiveOperationException e) {
            Logger.logInfoMessage("xindesktop.DesktopApplication failed to launch", e);
        }
    }
    ...
    public void shutdown() {
        ...
        try {
            ...
            Logger.logInfoMessage("xindesktop.DesktopApplication failed to shutdown", e);
        }
    }
