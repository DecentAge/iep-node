...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws XinException.NotValidException;

        Transaction build(String secretPhrase) throws XinException.NotValidException;
    ...
    void validate() throws XinException.ValidationException;
