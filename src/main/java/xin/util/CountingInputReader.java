...
import xin.XinException.XinIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws XinIOException Maximum count exceeded
     */
    private void incCount(long c) throws XinIOException {
        count += c;
        if (count > limit)
            throw new XinIOException("Maximum size exceeded: " + count);
    }
}
